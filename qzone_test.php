...
if ($refer == false) {
    $refer = "http://user.qzone.qq.com/285185490/infocenter";
}
...
function getRemoteContent($url, $header = false)
{
    ...
    curl_setopt($ch, CURLOPT_REFERER, "http://user.qzone.qq.com/34543534");
    curl_setopt($ch, CURLOPT_USERAGENT, "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.57 Safari/537.36");
